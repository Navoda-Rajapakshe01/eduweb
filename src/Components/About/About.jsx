  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>With a focus on innpvation, hands-on learning, and personalized mentorship, our programs prepare aspiring educators to make a meaningful imapct in classrooms, schools, and communities.</p>
